...
def create_mip_new(img, return_inds: bool = False, horizontal_angle: int = 0, modality: str = 'suv', device: str = 'cpu'):
    ...
    if device == 'cuda':
        ...
        if return_inds:
            ...
            cp_inds = cp.argmax(cp_img_rot, axis=2)
...
def create_mip_new_torch(img, return_inds: bool = False, horizontal_angle: float = 0, modality: str = 'suv', device: str = 'cpu'):
    '''Creates 2D MIP image from 3D image data
