...
if __name__ == "__main__":
    for i in range(1, 6):
        json_path = f'/mnt/sda1/Research/PET_CT_TS/Configs/json_datasets/num_of_mips_comparison/MIPs80/MIPs80_75th_25vth_IncSplit_0_180_fold{i}.json'
        args = Munch({'key_to_add': 'CT_mips',
                     'value_to_add': 'CT',
                     'key_to_take_from': 'SUV_mips'})
