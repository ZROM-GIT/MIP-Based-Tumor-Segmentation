################################################################################
# taken from: https://github.com/MrBlankness/LightM-UNet
# working with "lightmunet", virtual env created according to repo instructions
################################################################################
...
class LightMUNet(nn.Module):
    ...
    def __init__(
        ...
        super().__init__()
        self.name = "LightMUNet"  # Omri's addition, 05/2024
